...
public:
	...
	// Constructor 
	Autor(const Cadena& nombre, const Cadena& apellidos,  const Cadena& direccion) noexcept: nom_(nombre), apell_(apellidos), dir_(direccion){}
...
public:
	...
	// Constructor 
	Libro(const Autores& autores, const Cadena& ref, const Cadena& tit, const Fecha& fpub, double precio, size_t num_pag, size_t stock = 1);
